              ...
              <div class="col-lg-10 mx-auto ">
                <div class="career-search mb-60 ">
                  ...
                  <div class="filter-result">
                    <p class="mb-30 ff-montserrat text-white">
                      ...
                      <div class="job-left my-4 d-md-flex align-items-center flex-wrap">
                        ...
                        <div class="job-content">
                          ...
                          <ul class="d-md-flex flex-wrap text-capitalize ff-open-sans text-white">
                            <li class="mr-md-4">
                              <i class="zmdi zmdi-pin mr-2 text-white"></i>
                              &nbsp; Jacksonville , Florida &nbsp;
                            </li>
                            <li class="mr-md-4">
                              <i class="zmdi zmdi-money mr-2 text-white"></i>{" "}
                              2500-3500 / pm &nbsp;
                            </li>
                            <li class="mr-md-4">
                              <i class="zmdi zmdi-time mr-2 text-white"></i>
                              &nbsp; Part Time
                            </li>
                          </ul>
                        </div>
                      ...
                      <div class="job-left my-4 d-md-flex align-items-center flex-wrap">
                        ...
                        <div class="job-content">
                          ...
                          <ul class="d-md-flex flex-wrap text-capitalize ff-open-sans text-white">
                            ...
                            <li class="mr-md-4">
                              <i class="zmdi zmdi-money mr-2"></i> 2500-3500 /
                              pm &nbsp;{" "}
                            </li>
                            <li class="mr-md-4">
                    ...
                    <div class="job-box d-md-flex align-items-center justify-content-between mb-30">
                      <div class="job-left my-4 d-md-flex align-items-center flex-wrap">
                        ...
                        <div class="job-content">
                          ...
                          <ul class="d-md-flex flex-wrap text-capitalize ff-open-sans text-white">
                            <li class="mr-md-4">
                              <i class="zmdi zmdi-pin mr-2"></i>&nbsp; Mountain
                              View , California &nbsp;{" "}
                            </li>
                            <li class="mr-md-4">
                              <i class="zmdi zmdi-money mr-2"></i> 2500-3500 /
                ...
                <nav aria-label="Page navigation">
                  <ul class="pagination pagination-reset justify-content-center">
                    ...
                    <li class="page-item">
                      <a class="page-link" href="Careers">
                        1
                      </a>
                    </li>
                    <li class="page-item d-none d-md-inline-block">
                      <a class="page-link" href="Careers2">
                        2
                      </a>
                    </li>
                    <li class="page-item d-none d-md-inline-block">
